<div>
    <div class="header flex items-center mb-10">
        ...
        <div class="search flex justify-end gap-12 items-end basis-3/5">
            <div class="">
                <button wire:click="$dispatch('openModal', { component: { component: 'admin.create-edit-evaluated-modal'} })"
            ...
            <div id="alert-additional-content-1"
                ...
                <div class="mt-2 mb-4 text-sm">
                    @if (isset($rotationCarriers) && is_object($rotationCarriers))
                        <div class="mb-4">
                            <h3 class="text-lg font-medium">Aplicación Fragancias Portador A</h3>
                            <ul>
                                <li>
                        ...
                        <div class="mb-4">
                            <h3 class="text-lg font-medium">Aplicación Fragancias Portador B</h3>
                            <ul>
                                <li>
                                    <strong>Brazo Derecho:
