<div>
    ...
    <x-dialog-modal wire:model="createModal">
        ...
        <x-slot name="content">
            <form wire:submit="createProject" action="" method="POST">
                <div class="mb-4">
                    <x-label>
                        Nombre Proyecto
                    </x-label>
                    <x-input class="w-full" wire:model="project_name" required />
                </div>
                <div class="mb-4">
                    <x-label>
                        Cliente Nuevo
                ...
                <div class="mb-4">
                    @if (!$checked)
                        ...
                        <x-select wire:model="id_client" class="w-full" required>
                    ...
                    @else
                        <x-input type="text" placeholder="Cliente Nuevo" wire:model="client_name" required/>
                    @endif
                </div>
                <div class="mb-4">
