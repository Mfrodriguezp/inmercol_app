    ...
    public function actions(\App\Models\EvaluatedFragance $row): array
    {
        ...
        return [
            Button::add('edit')
                ...
                ->openModal('admin.evaluateds.rot-fragance-carriers-modal', ['evaluatedFragance' => $row->id_evaluated_fragance])
            ...
            Button::add('edit')
                ...
                ->openModal('admin.evaluateds.create-edit-evaluated-modal', ['evaluatedFragance' => $row->id_evaluated_fragance])
                ->tooltip('Editar'),
            Button::add('destroy')
                ...
                ->openModal('admin.evaluateds.destroy-evaluated-modal', ['evaluatedFragance' => $row->id_evaluated_fragance])
                ->can($canDestroy)
                ->tooltip('Eliminar'),
        ];
    }
